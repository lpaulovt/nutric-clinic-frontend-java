...
export function AssessmentModalForm({ onSubmit, onClose, values }: FormProps) {
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="mb-4">
              ...
              <FormControl>
                <Input placeholder="Informe o tipo" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
          ...
          render={({ field }) => (
            <FormItem className="mb-4">
              ...
              <FormControl>
                <Input
                  type="number"
                  placeholder="Informe o peso atual"
                  {...field}
                />
              </FormControl>
              <FormMessage />
          ...
          render={({ field }) => (
            <FormItem className="mb-4">
              ...
              <FormControl>
                <Input
                  type="number"
                  placeholder="Informe o peso ideal"
                  {...field}
                />
              </FormControl>
              <FormMessage />
